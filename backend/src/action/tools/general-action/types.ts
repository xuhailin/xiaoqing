...
export type GeneralAction =
  | { type: 'browser.goto'; url: string }
  | { type: 'browser.click'; url: string; selector: string }
  | { type: 'browser.fill'; url: string; selector: string; value: string }
  | { type: 'browser.wait'; url: string; selector: string }
...
export type ParseGeneralActionResult =
  | { status: 'ok'; action: GeneralAction }
  | { status: 'not_supported'; reason: string }
  | { status: 'validation_error'; reason: string; message: string };
