...
export const FEATURE_FLAGS = {
  ...
  embeddings: { key: 'FEATURE_EMBEDDINGS', defaultEnabled: false },
  hybridRecall: { key: 'FEATURE_HYBRID_RECALL', defaultEnabled: false },
  ...
  interactionTuningLearning: { key: 'FEATURE_INTERACTION_TUNING_LEARNING', defaultEnabled: false },
