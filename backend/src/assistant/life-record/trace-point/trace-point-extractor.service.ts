...
import type { TracePointDraft, TracePointExtractedBy, TracePointKind } from './trace-point.types';
...
const VALID_KINDS: TracePointKind[] = ['event', 'mood', 'mention', 'plan', 'reflection'];
