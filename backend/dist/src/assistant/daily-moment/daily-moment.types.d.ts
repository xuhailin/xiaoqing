...
export type DailyMomentSuppressionReason = 'tool_or_task_context' | 'serious_or_sensitive_context' | 'high_negative_emotion' | 'cooldown_active' | 'important_issue_in_progress' | 'policy_blocked';
export type DailyMomentMoodTag = '轻松' | '被逗了一下' | '温柔' | '小反转' | '被接住' | '安静的小幸福';
export type DailyMomentFeedback = 'like' | 'neutral' | 'awkward' | 'ignored';
export type DailyMomentEngagementSignalType = 'positive' | 'negative' | 'accepted_suggestion' | 'repeat_request' | 'bookmark_or_view';
