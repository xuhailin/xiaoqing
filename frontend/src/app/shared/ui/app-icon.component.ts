...
const APP_ICONS = {
  ...
  appChartLine: lucideChartLine,
  appCheck: lucideCheck,
  appChevronDown: lucideChevronDown,
  ...
  appLoader: lucideLoader,
  appImage: lucideImage,
  appChatBubble: lucideMessageCircle,
  appMessageSquare: lucideMessageSquare,
  appLayers: lucideLayers,
...
const APP_ICON_NAMES = {
  ...
  chartLine: 'appChartLine',
  check: 'appCheck',
  chatBubble: 'appChatBubble',
  chevronDown: 'appChevronDown',
  ...
  message: 'appMessage',
  'message-square': 'appMessageSquare',
  menu: 'appMenu',
  minus: 'appMinus',
  moon: 'appMoon',
  plus: 'appPlus',
