...
const FIELD_LAYOUT: FieldEntry[] = [
  ...
  { key: 'voiceStyle', label: '语言风格', hint: '定义说话方式、句式气质和情绪温度。', group: 'expression', rows: 4 },
  { key: 'adaptiveRules', label: '自适应表达', hint: '定义如何根据用户状态调整表达，而不改变核心人格。', group: 'expression', rows: 4 },
  { key: 'silencePermission', label: '留白许可', hint: '决定什么时候少说、停顿或不急着给结论。', group: 'expression', rows: 4 },
